...
use {
    ...
    solana_sdk::{
        account::WritableAccount, clock::{BankId, Slot, NUM_CONSECUTIVE_LEADER_SLOTS}, hash::Hash, pubkey::Pubkey, saturating_add_assign, signature::{Keypair, Signature, Signer}, timing::timestamp, transaction::Transaction
    },
    ...
    fn process_replay_results(
        ...
        for replay_result in replay_result_vec {
            ...
            if bank.is_complete() {
                ...
                //         let mut d = solana_sdk::account::AccountSharedData::new_data(
                //             a.lamports,
